...
MIGRATION_MODULES = {
    "sites": "cermat.contrib.sites.migrations"
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "cermat.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("Deiwid Decker Hoffer", "deiwidecker@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "cermat.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
